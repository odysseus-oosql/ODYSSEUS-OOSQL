...
unsigned short OOSQL_GetYear(OOSQL_SystemHandle* systemHandle, unsigned long* date);
unsigned short OOSQL_GetMonth(OOSQL_SystemHandle* systemHandle, unsigned long* date);
unsigned short OOSQL_GetDay(OOSQL_SystemHandle* systemHandle, unsigned long* date);
